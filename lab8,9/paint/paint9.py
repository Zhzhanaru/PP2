...
pygame.display.set_caption("Paint by Zhanaru")
#tickrate
...
shape = None
#icon
black_icon = pygame.image.load('paint\icons\BLACK.png')
black_icon = pygame.transform.scale(black_icon,(30,30))
red_icon = pygame.image.load('paint\icons\RED.png')
red_icon = pygame.transform.scale(red_icon,(30,30))
green_icon = pygame.image.load('paint\icons\GREEN.png')
green_icon = pygame.transform.scale(green_icon,(30,30))
blue_icon = pygame.image.load('paint\icons\BLUE.png')
blue_icon = pygame.transform.scale(blue_icon,(30,30))
circle_icon = pygame.image.load('paint\icons\circle.png')
circle_icon = pygame.transform.scale(circle_icon,(30,30))
rect_icon = pygame.image.load('paint\icons\square.png')
rect_icon = pygame.transform.scale(rect_icon,(30,30))
eraser_icon = pygame.image.load('paint\icons\eraser.jpg')
eraser_icon = pygame.transform.scale(eraser_icon,(30,30))
rhombus_icon = pygame.image.load('paint\icons\_rhombus.png')
rhombus_icon = pygame.transform.scale(rhombus_icon,(30,30))
white_icon = pygame.image.load('paint\icons\WHITE.png')
white_icon = pygame.transform.scale(white_icon,(30,30))
triangle_icon = pygame.image.load('paint\icons\_1.jpg')
triangle_icon = pygame.transform.scale(triangle_icon,(30,30))
while True:  
    ...
    screen.blit(rhombus_icon,(0,210))
