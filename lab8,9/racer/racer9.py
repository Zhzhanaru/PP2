...
pygame.display.set_icon(pygame.image.load('racer\images\main_icon.jpg'))
...
class Coins(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('racer\images\coin_icon.png')
...
basic_sound = pygame.mixer.music.load(
    'racer\sounds\Lil Jon & The Eastside Boyz - Get Low (Ost Need For Speed - Underground).mp3')
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        crash_sound = pygame.mixer.music.load('racer\sounds\w10_street racer_sounds_crash.wav')
        pygame.mixer.music.play(-1)
        pygame.quit()
        sys.exit()
